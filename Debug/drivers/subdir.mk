...
drivers/%.o: ../drivers/%.c drivers/subdir.mk
	...
	arm-none-eabi-gcc -std=gnu99 -DCPU_MKL46Z256VLL4_cm0plus -DCPU_MKL46Z256VLL4 -DFRDM_KL46Z -DFREEDOM -DSDK_DEBUGCONSOLE=1 -DCR_INTEGER_PRINTF -DPRINTF_FLOAT_ENABLE=0 -D__MCUXPRESSO -D__USE_CMSIS -DDEBUG -D__REDLIB__ -I"D:\MCU_E\workplace\app2\source" -I"D:\MCU_E\workplace\app2" -I"D:\MCU_E\workplace\app2\CMSIS" -I"D:\MCU_E\workplace\app2\drivers" -I"D:\MCU_E\workplace\app2\startup" -I"D:\MCU_E\workplace\app2\utilities" -O0 -fno-common -g -gdwarf-4 -Wall -c  -ffunction-sections  -fdata-sections  -ffreestanding  -fno-builtin -fmerge-constants -fmacro-prefix-map="$(<D)/"= -mcpu=cortex-m0plus -mthumb -D__REDLIB__ -fstack-usage -specs=redlib.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
